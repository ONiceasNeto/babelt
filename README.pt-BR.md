...
*Tradutor offline de saída de terminal. Vem com inglês → português do Brasil;
o pipeline não está preso a esse par.*
...
Comece por [`CONTRIBUTING.pt-BR.md`](CONTRIBUTING.pt-BR.md) — ele explica desde o que é um
...
[`CONTRIBUTING.pt-BR.md`](CONTRIBUTING.pt-BR.md) tem o passo a passo completo, incluindo o
